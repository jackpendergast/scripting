...
def check_if_a_port_is_used():
    try:
        port = int(input("Enter Which Port to Check: "))
        ...
        print("Invalid port. Please enter a valid IP Address")
    except Exception as e:
        print(f"Error occurred, please try again Error:\n{e}")
...
def get_system_uptime():
    print(f"System uptime is : {time.time() - psutil.boot_time(): .2f} seconds")

def get_number_of_cpu_cores():
    print(f"Number of cpu cores: {os.cpu_count()}")

def get_active_network_interface_name():
    print(f"Active Network interfaces name: {list(psutil.net_if_addrs().keys())}")

def get_hostname_and_FQDN():
...
def extrasFromAI():
    ...
    def scan_all_ports():
        print(Fore.LIGHTMAGENTA_EX + "=== Network Tools (No Third-Party Libraries) ===")
        print(Fore.YELLOW + "Gathering interfaces from system commands...")
...
def main():
    ...
    """)
    while True:
        print("Welcome to the Cyber App")
        print(Fore.RED+"1) Check if a port is in use")
        print(Fore.LIGHTBLUE_EX+"2) Scan all ports")
        print(Fore.LIGHTWHITE_EX+"3) Get System Timezone")
        print(Fore.BLUE+"4) Get Current Username")
        print(Fore.LIGHTGREEN_EX+"5) Get Disk Space")
        print(Fore.LIGHTWHITE_EX+"6) Get Total Ram")
        print(Fore.LIGHTWHITE_EX + "7) Get Number of CPUs")
        print(Fore.LIGHTWHITE_EX+"8) Get system uptime")
        print(Fore.LIGHTWHITE_EX+"9) Get Active Network interfaces")
        print(Fore.LIGHTWHITE_EX + "10) Get Hostname and FQDN")
        print(Fore.LIGHTWHITE_EX + "11) Get MAC Address")
        print(Fore.LIGHTWHITE_EX + "12) Check internet connection")
        # print(Fore.LIGHTRED_EX+"10) Close the app")
        try:
